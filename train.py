...
# parametrs from wang model
    ...
    # log warnings with default options that will be used in the script run
    ...
    optimizer = optim.AdamW( list(mwpgen_model.parameters()) + list(mwp2eq_model.parameters()) , lr=args.lr, eps=args.adam_eps, weight_decay=args.weight_decay)
